      ...
      <Row style={{ marginTop: '5%' }}>
        ...
        <Col span={18}>
          ...
          <Row style={{ marginBottom: '3%' }}>
            類別：
            <Col span={2}>
              <Button type="primary" href="/resource">
                全部
              </Button>
            </Col>
              ...
              return (
                <Col span={2}>
                  <Button
                    type="primary"
                    key={i}
                    href={'/resource?year=' + o.attributes.year}
                  >
                    {o.attributes.year}
                  </Button>
                </Col>
            ...
            <Button type="primary" href="/worship?isSpeacial=true">
              特别聚会
            </Button>
          </Row>
                      ...
                      <Col span={12}>
                        <img
                          src={
                            ...
                            youtube_parser(item.attributes.url) +
                            '/0.jpg'
                          }
                          style={{
                            borderRadius: '50%',
                  ...
                  <Col span={8} align="middle" justify="center">
                    <p>
                      <a href={'/video/?id=' + item.id}>
                        <Button type="primary">觀看視頻</Button>
                      </a>
                    </p>
                    <p>
