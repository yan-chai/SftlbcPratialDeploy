...
function Worship(props) {
  ...
  if (
    props.loading.effects['years/getRemote'] ||
    props.loading.effects['worship_list/getRemote']
  ) {
    return (
      <div>
        <LoadingOutlined />
  ...
  return (
    <PageLayout>
      ...
      >
        <Image
          src="https://sftlbc.s3.us-west-1.amazonaws.com/cover_0b9bb3e17b_e69fb98d63.jpg?updated_at=2023-01-07T03:23:14.052Z"
          style={{ maxHeight: '100%' }}
          preview={false}
        />
        <Title
        ...
        <a href="https://www.facebook.com/sftlbc" target="_blank">
          <Button
            type="primary"
        ...
        <a
          href="https://www.facebook.com/sftlbc"
          style={{ position: 'absolute', top: '70%' }}
          target="_blank"
        >
          <Button type="primary" shape="round" size="large" key={'facebook'}>
            &nbsp;&nbsp;Facebook&nbsp;&nbsp;
          </Button>
        </a>
        <a
          href="https://www.youtube.com/channel/UC503mIKA9hNXYgM-TGi8BnQ"
          target="_blank"
        >
          <Button
            type="primary"
      ...
      <div>
        <Row gutter={16} align="middle" justify="center" key={'sunday'}>
          <Title level={1} key="sunday">
            主日证道
          </Title>
        </Row>
        <Row gutter={16} align="middle" justify="center" key={'list'}>
            ...
            return (
              <Col span={2}>
                <Button
                  ...
                  key={i}
                  onClick={() => {
                    history.push('/worship?year=' + o.attributes.year);
                  }}
                >
                  {o.attributes.year}
                </Button>
          ...
          <Button
            ...
            key="special"
            onClick={() => {
              history.push('/worship?isSpeacial=true');
            }}
          >
            Special
          </Button>
        ...
        pagination={{
          onChange: (page) => {
            if (history.location.query.isSpeacial == 'true') {
              ...
              history.push(
                'worship?year=' + history.location.query.year + '&page=' + page,
              );
            } else {
        ...
        renderItem={(item) => (
          <List.Item key={item.title}>
            ...
            >
              ...
              <Col span={6} align="middle" justify="center">
                <p>
                  <a href={item.attributes.weekly_report}>
                    <Button
                      type="primary"
                      shape="round"
                      disabled={item.attributes.weekly_report == null}
                    >
                      查看周报
                    </Button>
                  </a>
