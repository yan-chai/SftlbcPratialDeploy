...
export default defineConfig({
  ...
  routes: [
    ...
    {
      path: 'resource',
      component: '@/pages/resource/worship.js',
      title: '主日崇拜',
    },
    {
      path: 'dailyBread',
      component: '@/pages/resource/dailyBread.js',
      title: '每日靈修',
    },
    {
      path: 'ministry',
      component: '@/pages/ministry/ministry.js',
      title: '教会事工',
    },
    {
      path: 'englishBibleGroup',
      component: '@/pages/ministry/englishBibleStudy.js',
      title: '英語查經小組',
    },
    {
      path: 'adult',
      component: '@/pages/ministry/adult.js',
      title: '成人主日學',
    },
    { path: 'pray', component: '@/pages/ministry/pray.js', title: '禱告小組' },
    {
      path: 'fellowship',
      component: '@/pages/ministry/fellowship.js',
      title: '團契小組',
    },
    { path: 'kid', component: '@/pages/ministry/kid.js', title: '兒童事工' },
    {
      path: 'mission',
      component: '@/pages/ministry/mission.js',
      title: '兒童事工',
    },
    {
      path: 'testimony',
      component: '@/pages/testimony/testimony.js',
      title: '活动见证',
    },
    { path: 'new', component: '@/pages/new/new.js', title: '新人指南' },
    { path: 'FAQ', component: '@/pages/new/FAQ.js', title: 'Q&A' },
    { path: 'about', component: '@/pages/about/about.js', title: '关于真光' },
    {
      path: 'constitution',
      component: '@/pages/about/constitution.js',
      title: '教會會章',
    },
    ...
    {
      path: 'support',
      component: '@/pages/about/support.js',
      title: '奉獻支持',
    },
  ],
  fastRefresh: {},
